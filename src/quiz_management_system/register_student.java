    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
       ...
       Pattern digitPattern = Pattern.compile("\\d{10}");
        ...
        if(digitPattern.matcher(mob1).matches()){
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/quiz", "root","bevan");
            
            String str1="insert into stud_info(id,name,department,year,mobile,email,username,pass) values(0,?,?,?,?,?,?,?)";
            ...
            pstmt.setString(3,year9);   //subject
